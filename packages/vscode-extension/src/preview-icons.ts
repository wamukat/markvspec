export type PreviewIconName = "circle-x" | "cog" | "database" | "eye-off" | "info" | "languages" | "merge" | "panels-top-left" | "refresh-cw" | "route" | "satellite-dish" | "split" | "square-check-big" | "table" | "triangle-alert" | "unplug" | "waypoints";

export function renderPreviewIcon(name: PreviewIconName): string {
