...
interface PreviewClientScriptOptions {
  target: PreviewHtmlTarget;
  messages: ReturnType<typeof previewClientMessages>;
  sourceLabel?: string;
...
function renderPreviewClientScript(options: PreviewClientScriptOptions): string {
