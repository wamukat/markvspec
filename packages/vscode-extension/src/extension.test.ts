...
`;
  ...
  assert.match(displayContent, new RegExp(`<td>${markerBadge("E-Title", "element")}</td><td>${detailIdRef("E-Title")}</td><td>label</td><td>Login</td><td>${sourceCodePattern("${i18n.login.title}")}</td><td>-</td><td>always</td>`));
