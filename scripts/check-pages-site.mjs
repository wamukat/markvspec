...
expectContains(referenceIndexHtml, "document-list", "_site/docs/ja/reference/index.html should mention document-list export.");
...
const cliReferenceHtml = readSiteFile("docs/ja/reference/cli.html");
expectContains(cliReferenceHtml, "export document-list", "_site/docs/ja/reference/cli.html should document document-list export.");
expectContains(cliReferenceHtml, "document-list.md", "_site/docs/ja/reference/cli.html should state the document-list output file.");
expectContains(cliReferenceHtml, "0 errors / 0 warnings", "_site/docs/ja/reference/cli.html should explain diagnostics summary output.");
expectContains(cliReferenceHtml, "--fail-on-warnings", "_site/docs/ja/reference/cli.html should document validate warning mode.");
expectContains(cliReferenceHtml, "diagnose input", "_site/docs/ja/reference/cli.html should document diagnose input.");
expectContains(cliReferenceHtml, "--messages", "_site/docs/ja/reference/cli.html should document renderer messages option.");
expectContains(cliReferenceHtml, "admin.project.html", "_site/docs/ja/reference/cli.html should document project export base names.");
const enCliReferenceHtml = readSiteFile("docs/en/reference/cli.html");
expectContains(enCliReferenceHtml, "export document-list", "_site/docs/en/reference/cli.html should document document-list export.");
expectContains(enCliReferenceHtml, "--fail-on-warnings", "_site/docs/en/reference/cli.html should document validate warning mode.");
expectContains(enCliReferenceHtml, "diagnose input", "_site/docs/en/reference/cli.html should document diagnose input.");
expectContains(enCliReferenceHtml, "--messages", "_site/docs/en/reference/cli.html should document renderer messages option.");
expectContains(enCliReferenceHtml, "admin.project.html", "_site/docs/en/reference/cli.html should document project export base names.");
expectContains(readSiteFile("docs/en/recipes/pdf-export.html"), "--fail-on-warnings", "_site/docs/en/recipes/pdf-export.html should link CI validation to CLI options.");
expectContains(readSiteFile("docs/ja/recipes/pdf-export.html"), "--fail-on-warnings", "_site/docs/ja/recipes/pdf-export.html should link CI validation to CLI options.");
