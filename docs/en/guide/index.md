...
9. [Partial Updates](./partial-updates.md): Describe targeted display updates as intent. Write the request and update semantics, not raw framework attributes.
...
rendered dynamically from the published `.vspec.md` source as the generated
design document. Runtime failures show diagnostics and source/raw links instead
of a pre-generated example HTML fallback.
...
- [Project Documents](../../../examples/project/account-project.html): project preview source and `export document-list` inventory example.
