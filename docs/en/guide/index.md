...
2. [Document Structure](document-structure.html): Learn where prose and structured DSL content belong. This keeps human-readable notes and parser-readable structure from blurring together.
