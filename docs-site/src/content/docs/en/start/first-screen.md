...
Open any folder in VS Code, create `hello.vspec.md`, paste the Hello Screen source from [Start](/markvspec/en/start/), and save it.
...
When you need inputs, validation, or server requests, use [Guide](/markvspec/en/guide/)
and [Recipes](/markvspec/en/recipes/) instead of stretching the Hello Screen example.

## Next

- [Preview](/markvspec/en/start/preview/)
