...
If you prefer the CLI, see [CLI reference](/markvspec/en/reference/cli/) for options.
...
project file, use CLI `export document-list`. See [CLI reference](/markvspec/en/reference/cli/).
