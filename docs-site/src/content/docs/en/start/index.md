...
If you prefer the CLI, pass the same file. See [CLI reference](/markvspec/en/reference/cli/) for options.
...
- [First Screen](/markvspec/en/start/first-screen/): Read Hello Screen.
- [Preview](/markvspec/en/start/preview/): Open the VS Code live preview.
- [Export](/markvspec/en/start/export/): Export HTML / PDF.

For one screen, start with one `.vspec.md` file. When you need to review a group
of screens and templates together, add a `.vspec.project.md` project file later.
Project files are covered in [File Format](/markvspec/en/reference/file-format/).

## Next

- [Examples](/markvspec/en/examples/): More examples to read after the first file.
- [Guide](/markvspec/en/guide/): MarkVSpec basics.
- [Reference](/markvspec/en/reference/): Syntax details.
