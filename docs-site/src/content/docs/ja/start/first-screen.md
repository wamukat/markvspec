...
VS Code で任意のフォルダを開き、`hello.vspec.md` を作ります。[はじめる](/markvspec/ja/start/) の Hello Screen ソースを貼り付けて保存してください。
...
[ガイド](/markvspec/ja/guide/) と [レシピ](/markvspec/ja/recipes/) の該当ページを見ながら増やしてください。

## 次

- [プレビュー](/markvspec/ja/start/preview/)
