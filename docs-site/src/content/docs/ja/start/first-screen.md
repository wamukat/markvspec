...
VS Code で任意の folder を開き、`hello.vspec.md` を作ります。[Start](/markvspec/ja/start/) の Hello Screen source を貼り付けて保存してください。
...
[Guide](/markvspec/ja/guide/) と [Recipes](/markvspec/ja/recipes/) の該当ページを見ながら増やしてください。

## 次

- [Preview](/markvspec/ja/start/preview/)
